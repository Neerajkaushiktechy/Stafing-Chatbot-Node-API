...
const {admin_login,get_nurse_by_id, add_facility, logout, get_facility, get_nurses, add_nurse, add_nurse_type, get_nurse_type, edit_facility, get_facility_by_id, delete_facility,delete_nurse, delete_service, get_nurse_types, delete_nurse_type, edit_nurse_type, edit_nurse, get_shifts} = require('../controller/admin_controller');
...
router.get('/get-shifts', get_shifts)
